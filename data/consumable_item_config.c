...
CONSUMABLE_PROTOTYPE(
    ITEM_CONSUMABLE_HP,
    "Health Potion",
    COLOR_PAIR(COLOR_HEALTH) | A_ALTCHARSET,
    false,
    CHAR_POTION,
    HEALTH,
    {10, 50}
...
CONSUMABLE_PROTOTYPE(
    ...
    "Max Health Potion",
    COLOR_PAIR(COLOR_HEALTH) | A_BOLD | A_UNDERLINE | A_ALTCHARSET,
    true,
    CHAR_POTION,
    HEALTH,
    {1, 6}
...
CONSUMABLE_PROTOTYPE(
    ...
    "Stamina Potion",
    COLOR_PAIR(COLOR_STAMINA) | A_BOLD | A_UNDERLINE | A_ALTCHARSET,
    true,
    CHAR_POTION,
    STAMINA,
    {1, 6}
